...
class Links extends StatefulWidget {
  ...
  Links(List<dynamic> message) {
    this.message = message;
  }

  @override
  State<StatefulWidget> createState() {
    return LinksState(message);
  }
}
...
class LinksState extends State<Links> {
  ...
  LinksState(List<dynamic> message) {
    this.message = message;
  }
                                      ...
                                      FlatButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (_formKey.currentState
                                              .validate()) {
                                            await Data().insert("links",
                                                {"message": newBookmarkUrl,"title":newBookmarkTitle,"date":formatted});
                                            this.message =
                                            await Data().getLinks();
